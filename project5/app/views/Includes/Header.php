            ...
            <div class="row">
                ...
                <div class="col-8 menu-box">
                    ...
                    <ul class="menu-items">
                        ...
                        <?php else : ?>
                            <li><a href="<?php echo URLROOT ?>/user/reservationoverzicht">MIJN RESERVERING</a></li>
                            <li><a href="<?php echo URLROOT ?>/user">ACCOUNT</a></li>
                            <li><a href="<?php echo URLROOT ?>/login/logout">UITLOGGEN</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
