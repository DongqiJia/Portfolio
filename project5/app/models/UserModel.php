...
class UserModel
{
    ...
    // Reservation overzicht pagina
    public function getReservation()
    {
        $this->db->query('SELECT p.firstName
                                ,p.infix
                                ,p.lastName
                                ,o.day
                                ,o.timeFrom
                                ...
                                ,r.id as id
                          from person p 
                          inner join reservation r on r.personId = p.Id
                          inner join `table` t on t.Id = r.tableId
                          inner join openingtime o on o.Id = r.dayId
                          inner join user u on u.personId = p.Id
        ');
